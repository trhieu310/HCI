...
const MainButton = ({navigation, route, icon, to = 'Personal', title, bgColor, right, iconBg, color}) => {
    ...
    return (
        <TouchableOpacity style={[styles.mainButton, {backgroundColor: bgColor}]} onPress={() => navigation.navigate(to ? to : 'Personal')} >
            <View style={[styles.viewLeftIcon, {backgroundColor: iconBg ? iconBg : 'transparent'}]}>
